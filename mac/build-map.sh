...
dsv2json --input-encoding latin1 -r ';' -n < Basico_PB.csv > pb-censo.ndjson
...
ndjson-map 'd[0].properties = {renda: Number(d[1].V005.replace(",", "."))}, d[0]' < pb-ndjson-join.ndjson > pb-ortho-comdado.ndjson
