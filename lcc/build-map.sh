...
#EXP_PROPRIEDADE='d[0].properties = {mulheres: Number(d[1].V083.replace(",", "."))}, d[0]'
#EXP_ESCALA='z = d3.scaleThreshold().domain([0, 250, 500, 750, 1100]).range(d3.schemeOrRd[4]), d.features.forEach(f => f.properties.fill = z(f.properties.mulheres)), d'
